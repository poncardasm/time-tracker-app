          ...
          <table className="w-full text-left">
              ...
              <tr>
                <th className="px-6 py-3 w-10">
                  <input
                    type="checkbox"
                    checked={
                      selectedIndices.length === tasks.length &&
                      tasks.length > 0
                    }
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
              {tasks.map((task, index) => {
                ...
                const dateStr = new Date(task.startTime).toLocaleDateString(
                  undefined,
                ...
                const endTimeStr = new Date(task.endTime).toLocaleTimeString(
                  undefined,
                  {
                    hour: "2-digit",
                    minute: "2-digit",
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 font-medium">
                      <div className="flex items-center justify-between group">
                        ...
                        <button
                          ...
                          className="text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity p-1"
                        >
                          <svg
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 font-mono text-right">
